...
Schedule a cron job to run every Monday at 3am with the following prompt:
Send a summary email via mailgun to greg@udon.org and Niko.butt@gmail.com from nanobot@triptrak.link with any fargo changes for the group named "ox-monday". 
